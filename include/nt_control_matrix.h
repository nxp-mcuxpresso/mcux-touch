...
enum nt_control_matrix_control_gestures
{
    ...
    NT_MATRIX_1HOLD       = 3, /*!< Press adn hold one finger control gesture */  
    NT_MATRIX_2HOLD       = 4, /*!< Press adn hold two fingers control gesture */   
    NT_MATRIX_SWIPE_UP    = 5, /*!< Swipe up control gesture */
    NT_MATRIX_SWIPE_DOWN  = 6, /*!< Swipe down control gesture */
    NT_MATRIX_SWIPE_LEFT  = 7, /*!< Swipe left control gesture */
    NT_MATRIX_SWIPE_RIGHT = 8, /*!< Swipe right control gesture */
    NT_MATRIX_SWIPE_HOLD_UP   = 9,  /*!< Swipe and hold up control gesture */
    NT_MATRIX_SWIPE_HOLD_DOWN = 10, /*!< Swipe and hold down control gesture */
    NT_MATRIX_SWIPE_HOLD_LEFT = 11, /*!< Swipe and hold left control gesture */
    NT_MATRIX_SWIPE_HOLD_RIGHT= 12, /*!< Swipe and hold right control gesture */
    NT_MATRIX_ZOOM_IN     = 13, /*!< Zoom in control gesture */
    NT_MATRIX_ZOOM_OUT    = 14,/*!< Zoom out control gesture */
};
...
struct nt_control_matrix
{
    ...
    uint32_t hold_interval;           /*!< Minimum time interval to recognize hold gestures. */
