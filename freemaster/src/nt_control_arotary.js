...
function NTControl_arotary(symbol, addr)
{
    ...
    var st = pcm.DefineSymbol(this._symbol, this._addr, "nt_control_data*").then((res) => {
      var st = pcm_read_ptr_new(this._symbol + "->data").then((res) => {
        var st = pcm.DefineSymbol(this._symbol + "->data", res.data, "nt_control_arotary_data").then((res) => {
          var st = pcm_read_ptr_new(this._symbol + "->rom->control_params").then((res) => {
            var st = pcm.DefineSymbol(this._symbol + "->rom->control_params", res.data, "nt_control_arotary*").then((res) => {
...
NTControl_arotary.prototype.GetPosition = function(callback)
{
