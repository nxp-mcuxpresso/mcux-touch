...
$("#modules-link").click(function() {
  $(" .touchsw, .tables-ext, .controls, .electrodes, .debug, .genconf, .cross").fadeOut(100);
  $(".modules").fadeIn(100);
});

$("#theme-link").click(function() {
  $(".modules, .touchsw, .controls, .electrodes, .debug, .genconf, .cross").fadeOut(100);
  $(".tables-ext").fadeIn(100);
});

$("#touchsw-link").click(function() {
  $(".modules, .tables-ext, .controls, .electrodes, .debug, .genconf, .cross").fadeOut(100);
  $(".touchsw").fadeIn(100);
});

$("#controls-link").click(function() {
  $(".modules, .tables-ext, .touchsw, .electrodes, .debug, .genconf, .cross").fadeOut(100);
  $(".controls").fadeIn(100);
});

$("#electrodes-link").click(function() {
  $(".modules, .tables-ext, .controls, .touchsw, .debug, .genconf, .cross").fadeOut(100);
  $(".electrodes").fadeIn(100);
});

$("#debug-link").click(function() {
  $(".modules, .tables-ext, .controls, .electrodes, .touchsw, .genconf, .cross").fadeOut(100);
  $(".debug").fadeIn(100);
});

$("#generated-config").click(function() {
  $(".modules, .tables-ext, .controls, .electrodes, .touchsw, .debug, .cross").fadeOut(100);
  $(".genconf").fadeIn(100);
});

$("#cross-talk").click(function() {
    $(".modules, .tables-ext, .controls, .electrodes, .touchsw, .debug, .genconf").fadeOut(100);
    $(".cross").fadeIn(100);
  });
