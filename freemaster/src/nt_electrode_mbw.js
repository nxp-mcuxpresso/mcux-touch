...
*/
 ...
 /* NTElectrode_mbw class */
  
function NTElectrode_mbw(module, symbol, addr, type)
{
...
NTElectrode_mbw.prototype.OnLinkClicked = function()
{
    var vname_measured_smooth     = this._name + "_measured_smooth";
    ...
    var vname_smooth_baseline = this._name + "_smooth_baseline";
    const vname_measured_smooth_prom = this.DefineSignalVariable(vname_measured_smooth);
    ...
    const vname_smooth_baseline_prom = this.DefineSmoothBaselineVariable(vname_smooth_baseline);
    
    Promise.all([vname_measured_smooth_prom, vname_predicted_prom, vname_baseline_prom, vname_noise_prom, vname_evnt_cnt_prom, vname_deadband_prom, vname_deadband_h_prom, vname_smooth_baseline_prom]).then((res) => {
          if(res)
          {
            // scope variables
            var vars = [ 
                {"variable":vname_measured_smooth, "visible":true, "color":3026413, "y_block":0 }, 
                ...
                {"variable":vname_smooth_baseline, "visible":true, "color":1804737, "y_block":0 },
...
NTElectrode_mbw.prototype.GetKeydetGui = function(shieldding)
{
  var str = "";
...
NTElectrode_mbw.prototype.UpdateGuiKeydetRaw = function(shieldding)
{
