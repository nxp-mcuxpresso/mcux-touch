...
/* TSI TOUCH PAD on FRDMKE17z512 - self electrodes */
#define FRDM_TOUCH_BOARD_TSI_1  TF_TSI_SELF_CAP_CHANNEL_19                 /* PTD16 TSI0  */
#define FRDM_TOUCH_BOARD_TSI_2  TF_TSI_SELF_CAP_CHANNEL_3                  /* PTA1  TSI1 */  
